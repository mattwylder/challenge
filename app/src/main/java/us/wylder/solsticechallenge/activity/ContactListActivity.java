package us.wylder.solsticechallenge.activity;
...
import us.wylder.solsticechallenge.fragment.ContactDetailFragment;
import us.wylder.solsticechallenge.fragment.ContactListFragment;
...
public class ContactListActivity extends FragmentActivity
    ...
    public void onItemSelected(Contact item) {
        if (mTwoPane) {
            ...
            arguments.putParcelable(ContactDetailFragment.ARG_ITEM_ID, item);
            ...
            detailIntent.putExtra(ContactDetailFragment.ARG_ITEM_ID, item);
